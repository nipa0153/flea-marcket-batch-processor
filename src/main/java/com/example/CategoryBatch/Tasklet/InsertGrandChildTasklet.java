...
@Component
public class InsertGrandChildTasklet implements Tasklet {

    private static final Logger log = LogManager.getLogger(InsertGrandChildTasklet.class);

    private TransactionTemplate transactionTemplate;

    private final JdbcTemplate jdbcTemplate;

    public InsertGrandChildTasklet(JdbcTemplate jdbcTemplate, TransactionTemplate transactionTemplate) {
