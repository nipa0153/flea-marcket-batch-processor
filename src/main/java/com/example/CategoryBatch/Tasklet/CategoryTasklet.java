...
// public CategoryTasklet(JdbcTemplate template, TransactionTemplate
// transactionTemplate) {
...
// LogManager.getLogger(CategoryTasklet.class);

// @Override
// public RepeatStatus execute(@SuppressWarnings("null") StepContribution
// contribution,
